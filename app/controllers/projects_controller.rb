class ProjectsController < ApplicationController
  ...
  def show
    ...
    @not_canceled_participants = @project.participants.where(applikations: { cancel: false }).group(:id)
    @canceled_participants = @project.participants.where(applikations: { cancel: true }).group(:id)
    #@default_project_image_id = @project.project_category_id
